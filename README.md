...
# artifacts - 
# configuration of components(Data ingestion,Data transformation, Model training) which tells that from which side data came, path of data and its output is called or stored in Artifacts 
